...
{
      11,     0,    -1,    12,     5,    -1,    13,    -1,    14,    -1,
      17,    -1,     6,    15,     7,    17,    -1,    16,    -1,    15,
       8,    16,    -1,    12,    18,    -1,    -1,     4,    -1,    -1,
       9,     3,    -1
};
...
static const char *const yytname[] =
{
  ...
  "','", "':'", "$accept", "tree", "subtree", "leaf", "internal",
  "branchlist", "branch", "name", "length", 0
};
#endif
...
{
       0,   256,   257,   258,   259,    59,    40,    41,    44,    58
};
# endif
...
{
      10,    11,    10,     0,     0,     3,     4,     5,    12,     0,
       7,     1,     2,     0,     9,    10,    10,    13,     6,     8
};
...
{
       0,     4,     6,    11,    12,    13,    14,    17,    12,    15,
      16,     0,     5,     9,    18,     7,     8,     3,    17,    16
};
...
#line 54 "newick.y"
    { 
		                                          ...
		                                          _newick_tree_print((yyvsp[(1) - (2)].nPtr)); 
							  (yyval.nPtr) = (yyvsp[(1) - (2)].nPtr); 
							  _newick_tree_ = (yyvsp[(1) - (2)].nPtr);
							  return(1); 
							}
    break;
...
#line 74 "newick.y"
    { 
                                                          /* printf("leaf\n"); */
							  _newick_node_t* tmp = make_node((yyvsp[(1) - (1)].nameVal)); 
							  (yyval.nPtr) = tmp;
							}
    break;
...
#line 81 "newick.y"
    { 
                                                          /* printf("internal\n"); */
							  (yyvsp[(2) - (4)].nPtr)->name = (yyvsp[(4) - (4)].nameVal);
...
#line 88 "newick.y"
    { 
							  ...
							  _newick_add_child(tmp, (yyvsp[(1) - (1)].nPtr));
	    						  (yyval.nPtr) = tmp; 
                                                        }
    break;
...
#line 94 "newick.y"
    { 
							  ...
							  _newick_add_child((yyvsp[(1) - (3)].nPtr), (yyvsp[(3) - (3)].nPtr));
...
#line 101 "newick.y"
    { 
                                                          /* printf("branch\n"); */
							  (yyvsp[(1) - (2)].nPtr)->dist = (yyvsp[(2) - (2)].numberVal); 
							  (yyval.nPtr) = (yyvsp[(1) - (2)].nPtr); 
							}
    break;
...
#line 109 "newick.y"
    { 
	                                                   /* printf("WORD\n");*/
							   (yyval.nameVal) = (yyvsp[(1) - (1)].nameVal); 
							}
    break;
...
#line 116 "newick.y"
    { 
	                                                  /* printf("NUMBER\n"); */
							  (yyval.numberVal) = (yyvsp[(2) - (2)].numberVal); 
							}
    break;
